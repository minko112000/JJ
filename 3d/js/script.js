...
$('.num-tab-parent div i').click(function () {
  if ($(this).hasClass('hide-tab')) {
    $(this).removeClass('hide-tab')
    $(this).css('transform', 'rotate(180deg)')
    $('.num-tab-parent').css('height', '250px')
    $('.num-parent').css('height', 'calc(100% - 255px)')
  } else {
    $('.num-tab-parent').css('height', '50px')
    $('.num-parent').css('height', 'calc(100% - 55px)')
    $(this).addClass('hide-tab')
    $(this).css('transform', 'rotate(0deg)')
  }
})

$('.num-tab-parent div b').click(function () {
  let p = $(this).attr('data')
  $('#num-tab-demo').text($(this).text())
  $('.num-parent').scrollTop(1480 * p)
})
